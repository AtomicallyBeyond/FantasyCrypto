...
public class Constants {
    ...
    public static final int FETCH_TIME_CONSTANT_UPDATE = 60 * 1000;
    public static final int FETCH_TIME_CONSTANT_SERVER = 5 * 60 * 1000;
    public static final int FETCH_PAGE_COUNT = 5;
}
